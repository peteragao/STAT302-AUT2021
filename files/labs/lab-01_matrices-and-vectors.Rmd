...
**2f.** What is the *expected* column variance for each column? Which matrix has observed column means that are closer to this expectation? Why do you think that is?
