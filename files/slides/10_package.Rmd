---
title: "STAT 302, Lecture Slides 10"
...
```{r, eval = FALSE}
devtools::install(build_vignettes = TRUE, build_opts = c())
library(Demo)
...
```{r, eval = FALSE}
devtools::install_github("peteragao/demoProject3")
library(demoProject3)
?my_pow
```
...
# Step A8: Set up a GitHub Actions (*)
...
# Step A9: Set up tests in your package (*)
