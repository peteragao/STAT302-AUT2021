...
.pushdown[.center[[Much, much more! (Click me for a cheat sheet!)](https://github.com/rstudio/cheatsheets/raw/master/data-visualization.pdf)]]
...
1. Try to reproduce the plot below.

2. Create your own visualization and submit to Piazza.

```{r, echo = F, fig.height = 4.5}
ggplot(gapminder, aes(x = year, y = log(gdpPercap), color = continent, group = country)) +
  geom_line(linetype = 'dashed') + facet_wrap(~continent) + 
  theme_bw(base_size = 16) + 
