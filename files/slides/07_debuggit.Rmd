...
.middler[<img src="images/bugsquash.gif" alt="" height="450"/>]
...
4. Public or Private. If private, you **must** add both `peteragao` and the grader as collaborators (I will post the grader's GitHub account).
...
1. Navigate to [the shortlab section of the course webpage](https://peteragao.github.io/STAT302-AUT2021/short_labs.html).
...
Don't forget, if you created a private repository, be sure to add both `peteragao` and the grader as collaborators.
