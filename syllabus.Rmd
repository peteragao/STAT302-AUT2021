...
Typically, each 80 minute class session will be broken up into a 45 minute lecture, a 5 minute break, and a 30 minute lab. Lab time will be an opportunity for you to practice coding, work collaboratively on assignments, and ask for help.
  ...
  * **Projects**: Instead of exams, you will be assigned three projects throughout the course. We will dedicate at least two lab sessions to each project and you will have about one week to complete each.
    ...
    * Project 3 focuses on version control and data analysis workflow.
...
Your final grade will be calculated as follows:
  ...
  * 15%: Short Labs
  * 25%: Labs
  * 10%: Minimum grade from Project 1 and Project 2
  * 20%: Maximum grade from Project 1 and Project 2
  * 30%: Project 3
  * 2% (extra credit): Piazza discussion participation. Both questions and answers will be considered.
  
Final grades will be curved, but only to help you. Consistent and excellent work will always be rewarded with an excellent grade,
regardless of the performance of the rest of the class.
...
### Feedback
  I encourage and appreciate your feedback throughout the quarter. You are welcome to provide feedback on any aspect of the course at any time via email or in person. If you would prefer to do so confidentially, you can do so through the form [here](https://forms.gle/pyjQB57dqyqEq3M99).
...
### Conduct
The University of Washington Student Conduct Code (WAC 478-121) defines prohibited academic and behavioral conduct and describes how the University holds students accountable as they pursue their academic goals. Allegations of misconduct by students may be referred to the appropriate campus office for investigation and resolution. More information can be found online at https://www.washington.edu/studentconduct/}{\color{PineGreen}https://www.washington.edu/studentconduct/
...
[Canvas Page](https://canvas.uw.edu/courses/1483089)
